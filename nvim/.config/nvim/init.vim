...
Plug 'Shougo/vimproc.vim', {'do': g:make}  " Asynchronous execution of tasks
...
let $FZF_DEFAULT_COMMAND =  "find * -path '*/\.*' -prune -o -path 'node_modules/**' -prune -o -path 'target/**' -prune -o -path 'dist/**' -prune -o  -type f -print -o -type l -prune -o -path 'elm-stuff/**' -print 2> /dev/null"
...
noremap <Leader>ft :ElmFormat<CR>
